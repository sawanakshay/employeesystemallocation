...
(function ($) {
    ...
    */      
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="editable-submit btn btn-sm btn-primary"><i class="fa fa-check" aria-hidden="true"></i></button>'+
    '<button type="button" class="editable-cancel btn btn-sm btn-warning"><i class="fa fa-times" aria-hidden="true"></i></button>';      
